...
const DiscussionChat = () => {
  ...
  const handleUpVote = async () => {
    try {
      ...
      const { data } = await axios.post(
        `https://code-clash-server.onrender.com/api/v1/chat/vote/${discussionData._id}`,
        { vote: 'up' },
        config
      );
      setUp(data.upvotes);
  ...
  const pageLoad = async () => {
    try {
      ...
      const { data } = await axios.post(
        `https://code-clash-server.onrender.com/api/v1/chat/slug`,
        { slug: slug },
        config
      );
      ...
      const message = await axios.get(
        `https://code-clash-server.onrender.com/api/v1/message/${data.chat[0]._id}`,
  ...
  const handleClick = async () => {
    if (answer === '') {
      ...
      try {
        ...
        const { data } = await axios.post(
          `https://code-clash-server.onrender.com/api/v1/message/`,
